                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 ">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url()?>auth/login_check" method="post">
                                        
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="student_email" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address..." name="student_email">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="student_id" aria-describedby="emailHelp"
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url()?>admin_auth">Admin Login?</a>
                                    </div>
                                    <div class="text-center">
