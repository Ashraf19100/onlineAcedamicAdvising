  ...
  <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <h3 class="my-6">Course List for to Add on <?=$present_semester?> </h3>
                <a class="btn btn-primary " href="<?= base_url() ?>add_new_course">Add new course  </a>
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <td><?= $post->credit; ?></td>
                    <td>
                    <a href="<?= base_url()?>add_course/index/<?=$post->id;?>" class="btn btn-primary btn-sm"  onclick="return confirm('Do you want to ADD this Course?');">ADD</a>
                    </td>
