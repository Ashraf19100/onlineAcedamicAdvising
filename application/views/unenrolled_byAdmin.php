  ...
  <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <h3>Student List of Enrolled courses for <?=$present_semester?> </h3>
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <td><?= $post->section; ?></td>
                    <td>
                    <a href="<?= base_url()?>admin_unenrolled/delete/<?= $post->id?>" class="btn btn-danger btn-sm"  onclick="return confirm('To Unenroll click on ok?');">Unenroll</a>
                    <a href="<?= base_url()?>admin_unenrolled/result/<?= $post->id?>" class="btn btn-success btn-sm"  onclick="return confirm('To Update result click OK');">Update Result</a>
