  ...
  <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <h3>Enrolled courses for <?=$present_semester?> </h3>
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <td><?= $post->credit; ?></td>
                    <td>
                    <a href="<?= base_url()?>admin_routine/create_routine/<?=$post->id;?>" class="btn btn-primary btn-sm"  onclick="return confirm('Do you want to ADD this Course?');">ADD</a>
                    </td>
